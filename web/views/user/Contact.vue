        ...
        <div class="row">
            <div class="col-md-6 pb-5">
                <iframe
                    ...
                    frameborder="0" style="width: 100%; height: 392px;border:0;" allowfullscreen aria-hidden="false"
                    tabindex="0">
                </iframe>
            </div>
            <div class="col-md-6 pb-5">
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="control-group">
                        <textarea class="form-control" rows="6" id="message" placeholder="Message" required
