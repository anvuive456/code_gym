...
const handleMouseOver = (event: Event) => {
    ...
    const dropdownToggle = target.querySelector(
        ".dropdown-toggle",
    ) as HTMLElement;
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg navbar-dark py-3">
            <a href="/" class="navbar-brand">
                <h1
                    class="m-0 display-4 font-weight-bold text-uppercase text-white"
                >
                    CodeGym
                </h1>
            </a>
            ...
            >
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <a href="/feature" class="nav-item nav-link"
                        >Our Features</a
                    >
                    ...
                    <template v-if="session.sessionData.value?.fullname">
                        <div class="nav-item dropdown">
                            ...
                            >
                                Xin chào,
                                {{ session.sessionData.value?.fullname }}
                            </a>
                            <ul
                    ...
                    <template v-else>
                        <a href="/signin" class="btn btn-primary mr-4"
                            >Đăng nhập</a
                        >
